"""
This file will perform a nine step calculation for the x and y components of the force of tension in my M3 lab. (It is not elegant! very brute force!)
"""
...
def main():
    # 1
    newtons = float(input("Enter mass of newtons: "))
    uncertainty = float(input("Enter uncertainty in newtons: "))
    theta = float(input("enter theta in degrees: "))
    # theta_uncertainty = float(input("enter theta uncertainty in degrees: "))

    # 2
    f = newtons * math.sin(math.radians(theta))
    # f = newtons * math.cos(math.radians(theta))
    # dm = uncertainty / 1000
